...
a<-ggplot(pred, aes(x =Day,group=Group,color=Group,fill=Group)) +
    ...
    geom_ribbon(aes(ymin = lwrS, ymax = uprS), alpha = 0.2,show.legend = FALSE) +
    geom_ribbon(aes(ymin = lwrP, ymax = uprP), alpha = 0.2,show.legend = FALSE) +
...
#plot both
c+a+b+scale_y_continuous(breaks=c(-20,0,20,40,60))
