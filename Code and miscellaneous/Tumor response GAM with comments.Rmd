...
per group, and we take into account the main effect of each treatment.
So this model effectively takes into account treatment and time? and the simples model only takes the effect of time.
