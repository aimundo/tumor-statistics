...
#original bases
p1<-ggplot(basis_plot,aes(x=time,y=value_orig,colour=as.factor(Basis)))+
  geom_line()+geom_point()+
  labs(y='Original basis function',fill="Basis Number")+
  facet_grid(~Basis)+
  theme_classic()+
  scale_color_aaas()
...
p2<-ggplot(basis_plot,aes(x=time,y=mod_val,colour=as.factor(Basis)))+
  geom_line(show.legend = FALSE)+geom_point(show.legend = FALSE)+
  labs(y='Modified basis function')+
  facet_grid(~Basis)+
  theme_classic()+
  scale_color_aaas()

#heatmap of the coefficient
p3<-ggplot(basis_plot,aes(x=Basis,y=Basis,fill=cof))+
  geom_tile(aes(color='black'),size=2,show.legend = FALSE)+
  geom_tile(size=2)+
  scale_fill_gradient(low = "white", high = "red")+ 
  geom_text(aes(label=round(cof,1)))+
  theme_classic()

p4<-ggplot(data=dat,aes(x=time,y=y))+
  geom_point()+
  geom_line(data=spl,aes(x=time,y=spl))+
  scale_color_aaas()+
  theme_classic()
