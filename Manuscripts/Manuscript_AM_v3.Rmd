...
ln<-length(basis1)*(length(coef(gm))-1) 
...
basis_plot$value<-basis$value #pasting basis values

ggplot(basis_plot,aes(x=time,y=value))+geom_line()+facet_grid(~Basis) #plotting
