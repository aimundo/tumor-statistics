...
#using lme
#lm_predict<-lm_predict%>%
#   mutate(fit = predict(lm1,lm_predict,se.fit = TRUE,type='response',level=0),
 #         se.fit = predict(lm1, lm_predict,se.fit = TRUE,type='response',level=0))
...
(ref:pairwise-comp) Pairwise comparisons for smooth terms. A: Pairwise comparisons for the full dataset. Significant differences exist where the interval does not cover 0. B: Pairwise comparisons for the full dataset. Significant differences exist where the interval does not cover 0.
