...
#linear model
lm1<-lm(StO2_sim ~ factor(Day) + Group + factor(Day) * Group, data = dat_sim)
  

#lm2<-lme(StO2_sim ~ Group + Day + Group:Day,
#                 data = dat_sim,
#                 random = ~ 1 | subject,
#                 correlation = corCompSymm(form = ~ 1 | subject)
#  )
...
What does this mean?
https://stats.stackexchange.com/questions/377609/rm-anova-time-as-continuous-or-categorical

If you treat time as a factor then you do get the changes over time!
