...
\title{Using generalized additive models to analyze biomedical non-linear longitudinal data: \emph{Beyond Linear Mixed Models and Repeated Measures ANOVA}}

\author[a]{Ariel I. Mundo}
\author[a]{Timothy J. Muldoon*}
\author[b]{John R. Tipton}

\authormark{Mundo \emph{et al}.}

\address[a]{Department of Biomedical Engineering, University of Arkansas, Fayetteville, AR, US}
\address[b]{Department of Mathematical Sciences, University of Arkansas, Fayetteville, AR, US}
...
{\centering \includegraphics[width=0.75\linewidth]{Full_document_SIM_rticles_No_Appendix_files/figure-latex/sim-smooth-plot-1} 
...
{\centering \includegraphics[width=0.75\linewidth]{Full_document_SIM_rticles_No_Appendix_files/figure-latex/plot-pairwise-comp-1} 
