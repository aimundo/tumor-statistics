...
In a longitudinal study, multiple measures on the same subject creates a _correlation_ and _covariance_ issue that needs to be incorporated into the model. In this case, _correlation_ can be defined as the relationship between different variables, e.g. how much one variable changes when other variable changes. It can be further decomposed in _between-subject_ correlation and _within-subject correlation_. In the first case, _between-subject correlation_ measures the correlation between subject means, whereas _within-subject correlation_ describes how much a measurement in a subject changes in regard to another to another measurement _in the same subject_ [@roy2006].  between repeated measures on the same subject can be defined as the relationship between the variability . The _correlation_ of the measures can be practically defined as is defined as the relationship between  
