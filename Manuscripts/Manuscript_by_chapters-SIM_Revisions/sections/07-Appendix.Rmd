...
```{r, quadratic-cases-Appendix, fig.width=12, fig.height=7, out.width='100%',fig.align='center', echo=FALSE,message=FALSE,fig.show='hold',fig.cap='(ref:quadratic-caption-appendix)'}
# linear response, correlated errors (subject effect)
