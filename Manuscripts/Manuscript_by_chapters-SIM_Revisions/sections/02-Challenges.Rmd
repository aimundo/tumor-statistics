...
We consider that a proper understanding of GAMs would be incomplete without a brief survey of contemporary statistical models. Particularly because it seems to be a disconnect between biomedical research and the current state of Statistics. Today, the Statistical landscape has changed drastically and yet, biomedical research at large continues to be confined to a 't-test', 'ANOVA' mentality. The shortcomings that such view produces cannot be properly addressed without a brief mention of statistical methods.
