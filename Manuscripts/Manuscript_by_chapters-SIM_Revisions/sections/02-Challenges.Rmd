...
To visually demonstrate the limitations of rm-ANOVA an LMEMs for longitudinal data with non-linear trends, this section presents a simulation experiment of a normally distributed response of two groups of 10 subjects each. An rm-ANOVA model (Equation \@ref(eq:linear-model)), and a LMEM  (Equation \@ref(eq:LMEM)) are fitted to each group, using R [@r] and the package _nlme_ [@nlme]. 
